...
INSERT INTO `careers` (`id`, `company`, `location`, `job_title`, `description`, `user_id`, `DATETIME_created`) VALUES
...
INSERT INTO `events` (`id`, `title`, `content`, `schedule`, `banner`, `DATETIME_created`) VALUES
...
(3, 'CS EVENT (Laptop)', '<p><strong style=\"color: rgba(0, 0, 0, 0.81);\">PM Laptop Scheme</strong><span style=\"color: rgba(0, 0, 0, 0.81);\">.... </span><a href=\"https://junaidrana.vercel.app/\" rel=\"noopener noreferrer\" target=\"_blank\" style=\"color: rgba(0, 0, 0, 0.81);\">Rana Junaid Hashim</a><span style=\"color: rgba(0, 0, 0, 0.81);\"> </span><em style=\"color: rgba(0, 0, 0, 0.81);\">velit incididunt ut culpa labore minim eiusmod </em><em>pariatur sunt duis consequat.</em> Est magna consectetur nisi veniam cupidatat adipisicing esse anim commodo irure irure laborum id. <u>Amet magna ex ullamco incididunt dolore do velit est id commodo veniam minim non Veli.</u></p>', '2026-06-06 10:05:00', '', '2024-02-19 19:07:28');
...
INSERT INTO `forum_comments` (`id`, `topic_id`, `comment`, `user_id`, `DATETIME_created`) VALUES
...
INSERT INTO `forum_topics` (`id`, `title`, `description`, `user_id`, `DATETIME_created`) VALUES
...
(1, 'Alumni- JECRC', 'info@jecrcmail.com', '0141-2770232', '1602738120_pngtree-purple-hd-business-banner-image_5493.jpg', 'A journey of Two decades for JECRC, having more than 4000 students on campus under 7 UG programs, has earned laurels to their students, faculty members and for the institute in many ways. More than 10000 alumni’s spread over the globe has climbed the ladder to leadership positions and providing mentorship to their juniors by way of skill development, incubation, startup, research and angel funding. Faith by government agencies for providing grant of more than 2 crores for setting up centre of excellence, state of art facilities for startup & incubation and providing platform to the students to develop their technical and managerial skills that is helping students to get placement in a reputed organization. Contribution towards International publications, technical activities, co-curricular activities by faculty members, students and delivery of Outcome based education is recognized by National Board of Accreditation and AICTE.\r\n <br/><br/><center><h2>Department of Computer Science</h2></center><br/>The Department of Computer Science & Engineering is one of the major departments established to meet the demand for well-qualified computer professionals and was established in the year 2001. The Department offers a 4-year degree program in Computer Science and Engineering. The program focuses on theoretical computer science as well as software and application development.');
...
CREATE TABLE `users` (
  ...
  `email` varchar(100) ,
  `password` text ,
  `type` varchar(10)  DEFAULT 'Alumnus' COMMENT 'Admin,Alumnus',
  `auto_generated_pass` text ,
  `alumnus_id` int(30) 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Riya Goyal', 'admin@gmail.com', '$2b$10$T3AaDtVF15J2PvFAEOrKge0b6/gWShoQnqoN0gz8MLkyQSUJHqyIC', 'admin', '', 0),
...
--
ALTER TABLE `alumnus_bio`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `careers`
--
ALTER TABLE `careers`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `courses`
--
ALTER TABLE `courses`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `events`
--
ALTER TABLE `events`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `event_commits`
--
ALTER TABLE `event_commits`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `forum_comments`
--
ALTER TABLE `forum_comments`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `gallery`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `system_settings`
--
ALTER TABLE `system_settings`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `id` int(30)  AUTO_INCREMENT, AUTO_INCREMENT=36;
COMMIT;
